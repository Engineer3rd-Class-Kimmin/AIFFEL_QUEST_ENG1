...
- Causal Multi-Head Self-Attention과 padding mask
...
전체 실행 노트북, 학습 손실, 성능 지표, 마스킹 검증, 명령 로그와 시각화 자료는
[`training_records/`](training_records/README.md)에 저장했습니다.

- 사전학습 `L1`: `5.596127 → 5.034127`
- 미세조정 분류 `L2`: `0.977593 → 0.002342`
- causal prefix 차이: `0.0`
- padding LM loss 차이: `0.0`
- 자동 검사: `18/19` 통과

긍정 probe 1건의 오분류도 일반화 한계로 숨기지 않고 함께 기록했습니다.
